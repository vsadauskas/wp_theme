...
function theme_scripts(){
    ...
    if ( !is_admin() ) {
		...
		wp_register_script('jquery', ASSETS_URL . '/assets/scripts/jquery-3.2.1.min.js', false, '3.2.1', true);

        wp_register_script('js_main', ASSETS_URL . '/assets/scripts/main.js', array('jquery'), '1.0', true);
...
function theme_stylesheets(){
	...
	if( $styles_path ) {
		...
		wp_register_style('reset-css', ASSETS_URL . '/assets/css/reset.css', array(), false, 'all');
		wp_register_style('fonts-css', ASSETS_URL . '/assets/css/fonts.css', array(), false, 'all');
		wp_register_style('custom-css', ASSETS_URL . '/assets/css/custom.css', array(), false, 'all');
		wp_register_style('styles-css', ASSETS_URL . '/assets/css/styles.css', array('reset-css', 'fonts-css', 'custom-css'), false, 'all');
...
//navigacijos iskvietimas
function custom_nav($menu, $clases)
{
	wp_nav_menu( array(
